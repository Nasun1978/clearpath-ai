              ...
              >
                ...
                <div className="flex flex-wrap gap-4 mt-auto pt-2 border-t border-slate-800">
                  ...
                  <div className="ml-auto flex items-end gap-2">
                    <Link
                      href={`/dashboard/projects/${p.id}/team`}
                      className="flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-semibold bg-teal-900/30 text-teal-300 hover:bg-teal-800/40 border border-teal-700/40 transition-colors"
                    >
